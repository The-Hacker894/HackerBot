...
if(msg.content === 'mrhacker is a pain in the neck') {
  ...
  if (msg.content === '@HackerBot#0162') {
    msg.channel.send('No need to mention me!')
  }
...
case "say":
    ...
    case "changelog":
      ...
      .addField('Most commands are no longer logged', 'Type >logging for more information')
      .addField('Added some more auto-responses', 'I\'ll let you figure out what they are :P')
      .addField('Added >channelcreate', '>channelcreate insertwhatevernamehere')
      .addField('Added >channeldelete', '>channeldelete')
      .addField('Fixed help', '>help')
      .addField('Added >untableflip','Reverse Tableflip')
      .addField('Added >saytts', 'Use HackerBot to say anything you want using TTS')
