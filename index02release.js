...
client.on("message", message => {
      ...
      case "rage":
        ...
        switch (args[1]) {
            ...
            case "usage":
              var embed = new Discord.RichEmbed()
                .setColor('00FF00')
                .setTitle('Uptime Usage')
                .addField('>uptime seconds','View the Bot Uptime in Seconds')
                .addField('>uptime minutes','View the Bot Uptime in Minutes')
                .addField('>uptime hours','View the Bot Uptime in Hours')
                .addField('>uptime usage','Get info on how to use the >uptime command')
                message.channel.sendEmbed(embed)
                break;
          }
        break;
  ...
  .setFooter("Version 0.2 Beta (Ban Usage)","https://cdn.discordapp.com/avatars/342054071060004884/04f1a7a65bd8467eb928e82b33e6d010.webp?size=1024")
  message.channel.sendEmbed(embed)
          break;
      case "banuser":
...
.setFooter("Version 0.2 Beta (Kick Usage)","https://cdn.discordapp.com/avatars/342054071060004884/04f1a7a65bd8467eb928e82b33e6d010.webp?size=1024")
message.channel.sendEmbed(embed)
      break;
	case "kickuser":
	if(message.guild.id === '273169968202252289')return;
...
.setFooter("Version 0.2 Beta (Usage)","https://cdn.discordapp.com/avatars/342054071060004884/04f1a7a65bd8467eb928e82b33e6d010.webp?size=1024")
message.channel.sendEmbed(embed)
      break;
		case "purgeall":
    if(message.guild.id === '273169968202252289')return;
	...
	case "woahmeme":
{
    ...
    case "botinvite":
    	...
    	.setURL('https://discordapp.com/oauth2/authorize?client_id=342054071060004884&scope=bot&permissions=14')
    	message.channel.sendEmbed(embed)
    	break;
    case "info":
    	var embed = new Discord.RichEmbed()
      ...
      .addField('Servers', client.guilds.size)
    	...
    	.addField('Testers', 'Corbs, Ion, DannyBoi, Shadow•™ | ▼DQ▼', false)
    	.addField('Version', '0.2 Beta')
      ...
      .setFooter("Version 0.2 Beta ","https://images-ext-1.discordapp.net/external/Z1krf1ZBQTM3mDkke47xThwIF4GEFG0doRAdKRVHgnY/%3Fsize%3D128/https/cdn.discordapp.com/avatars/342054071060004884/4b83b2aa5970b8d34db71fd986abfe30.jpg")
		message.channel.sendEmbed(embed)
    	break;
      case "help":
      ...
      .setFooter("Version 0.2 Beta ","https://cdn.discordapp.com/avatars/342054071060004884/04f1a7a65bd8467eb928e82b33e6d010.webp?size=1024")
...
case "say":
    ...
    case "changelog":
    	...
    	.setColor('FF0000')
    	.setTitle('0.2 BETA')
		  .addField('Removed the status commands','Just didn\'t need to exist')
      .addField('Added >serverinfo','View the current server info')
      .addField('Added >uptime usage','View the bot uptime')
      .addField('Updated >info with uptime and other things','>info')
      .addField('Attempting to make the code more compact','Takes up less space and prevent latency.')
   		message.member.sendEmbed(embed)
   	  	break;
     default:
