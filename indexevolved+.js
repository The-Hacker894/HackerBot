...
if (bnickisStaff) {
    ...
    case "devpage":
      var embed = new Discord.RichEmbed()
        ...
        .addField('Visit my Dev Page','I have cool stuff there')
	...
	case "woahmeme":
{
  ...
  case "danquote":
  {
    ...
    case "test":
    	...
    	message.author.sendFile('https://media.giphy.com/media/8GY3UiUjwKwhO/giphy.gif')
    	break;
    case "botinvite":
  ...
  case "botrps":
    switch (args[1]) {
        ...
        case "scissors":
          ...
          break;
        if (!args[1]) message.channel.send('Usage: >botrps rock || >botrps scissors || >botrps paper')
    }
    break;
case "kys":
